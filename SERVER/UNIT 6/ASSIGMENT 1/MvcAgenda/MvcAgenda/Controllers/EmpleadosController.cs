...
namespace MvcAgenda.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,FechaNacimiento,Teléfono,Email,DepartamentoId")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,FechaNacimiento,Teléfono,Email,DepartamentoId")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
