...
<div id="headerDiv">
    ...
    <asp:LinkButton ID="linkButtonEmployees" runat="server" CssClass="employeesBtn" PostBackUrl="~/WebForms/EmployeesForms/Employees.aspx">Empleados</asp:LinkButton>
    <asp:LinkButton ID="linkButtonLendings" runat="server" CssClass="lendingsBtn" PostBackUrl="~/WebForms/LendingsForms/Lendings.aspx">Prestaciones</asp:LinkButton>
    <br />
