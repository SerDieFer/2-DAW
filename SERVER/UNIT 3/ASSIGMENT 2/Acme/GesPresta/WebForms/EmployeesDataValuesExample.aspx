<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeesDataValuesExample.aspx.cs" Inherits="GesPresta.EmployeesDataValuesExample" %>
...
<body>
    <form id="formEmployee" runat="server">
        ...
        -->
        <asp:Label ID="lblEployeeData" runat="server" Visible="false"></asp:Label>
