<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LendingsDataValues.aspx.cs" Inherits="GesPresta.LendingsDataValues" %>
...
<body>
    <form id="formLending" runat="server">
         ...
         <div class="lendingDataButtonDiv">
             <asp:Button ID="btnSendDataLending" runat="server" Text="Enviar" PostBackUrl="~/WebForms/LendingsForms/PostBack Method/LendingsDataValuesResponse.aspx"/>
         </div>
    </form>
</body>
</html>
